        ...
        <main>
            ...
            <section id="features" className="features-section">
                <div className="container">
                    ...
                    <div className="features-grid">
                        <Link to="/notes" className="feature-card" data-aos="fade-up" data-aos-delay="100" style={{textDecoration: 'none'}}>
                            <i className="fas fa-file-pdf"></i>
                            <h3>PDF Notes</h3>
                            <p>Find and download all subject notes as PDFs. (Free for all)</p>
                        </Link>
                        <Link to="/smart-prep" className="feature-card" data-aos="fade-up" data-aos-delay="200" style={{textDecoration: 'none'}}>
                            <i className="fas fa-star"></i>
                            <h3>SmartPrep Zone</h3>
                            <p>{user ? "Access IMP Questions and PYQ analysis for exams." : "Get IMP Questions for exams. (Login Required)"}</p>
                        </Link>
                        <Link to="/request-note" className="feature-card" data-aos="fade-up" data-aos-delay="300" style={{textDecoration: 'none'}}>
                            <i className="fas fa-question-circle"></i>
                            <h3>Request a Note</h3>
                            <p>{user ? "Submit a request for any missing note." : "Easily submit a request for a missing note. (Login Required)"}</p>
                        </Link>
                        <Link to="/updates" className="feature-card" data-aos="fade-up" data-aos-delay="400" style={{textDecoration: 'none'}}>
                            <i className="fas fa-bell"></i>
                            <h3>College Updates</h3>
                            <p>{user ? "Check the latest official announcements." : "Stay informed with official announcements. (Login Required)"}</p>
                        </Link>
                        <Link to="/reminders" className="feature-card" data-aos="fade-up" data-aos-delay="500" style={{textDecoration: 'none'}}>
                            <i className="fas fa-clock"></i>
                            <h3>Study Reminders</h3>
                            <p>{user ? "Set browser notifications to stay disciplined." : "Set study reminders. (Login Required)"}</p>
                        </Link>
                    </div>
                </div>
            </section>
            ...
            <section id="cta" className="cta-section">
                <div className="container" data-aos="fade-up">
                    ...
                    {/* UPDATED: This button will now change based on login status */}
                    {user ? (
                        <Link to="/smart-prep" className="cta-button">Go to SmartPrep Zone</Link>
                    ) : (
